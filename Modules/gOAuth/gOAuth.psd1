#
# Module manifest for module 'gOAuth'
#
...
GUID = '5a785bb8-daad-45a4-8306-ac00d0674de5'
...
Description = 'Implements to OAuth2 protocol for Google properties'
...
FunctionsToExport = 'ConvertFrom-gOAuthUnixTimestamp', 'Get-gOAuthAccessToken', 'Get-gOAuthAccessTokenSDK', 'Get-gOAuthAuthorization', 'Get-gOAuthAuthorizationRefreshed', 'Get-gOAuthClientSecret', 'Get-gOAuthDecodeJwt', 'Get-gOAuthToken', 'Invoke-gOAuthLogin', 'Invoke-gOAuthRestMethod', 'Invoke-gOAuthRestMethodPaged', 'Open-gOAuthUri', 'Set-gOAuthAuthorization', 'Set-gOAuthAuthorizationRefreshed', 'Set-gOAuthClientSecret', 'Set-gOAuthClientSecretFromFile', 'Start-gOAuthApiConsole', 'Test-gOAuthCommand'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjf6uzAQU+LyunDdxsfi4I+CO
# USagghiiMIIFNTCCAx2gAwIBAgIQT/hgdSzRMK1Ptmol1X/K6zANBgkqhkiG9w0B
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBDXALoW
# Czr5uDV/vPXZ+1ImBvuYMA0GCSqGSIb3DQEBAQUABIIBAB2TaC0Q6YApj/YodDGe
# oZ2PF+nhPa8ZOM/9GBN8TDqdgCPnPBHJLb3SPNEOZzinWjq/aTv/22ML6vSguG5f
# uQjbmb5f110FNgyEd0xyqczZpW5qgDrbsoxX6p+HKZ+lL3kD0JKqFsX0NG2U3jOX
# /BP5qTgNBTd5kVVbzZKyuRn0DKitQUHbX8WKq5SlxuBNOfQaqhQSkQcpGKlhL59z
# A2syPLhHXjuiGWWEHHWZMZs20h/UdQFG0lSnpcBvTsaCEGOaobZRV5hIpECKpYSO
# zUQJkHyPK4G6QEukXrQhe5llaAKWY8QiNqLwCcjgK3OHhTNPvLytSrT4K3oFTPre
# Y1uhggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgCAQEwdjBiMQswCQYDVQQGEwJV
...
# HAYJKoZIhvcNAQkFMQ8XDTIwMDYzMDEyMzYyMlowIwYJKoZIhvcNAQkEMRYEFP06
# nlsQNTTqUnwTzyx5PfyKvtTkMA0GCSqGSIb3DQEBAQUABIIBABNVZdx+normo18I
# cP88lh4haBYXr8Xi8PGcned3FoNverYJ/E1Xlnw1SFHmh4c0mQIch77lCzueVsmw
# DaD/N/G3tdRRLycWzHRsavwTEMmNgUWRnVTFsQjeD3z3xkgJr17xovwYv4uIIATH
# lh+hzQlEW6WUuXsu3PTyJ3Dd7ToLnDRk2JnUbWA2MXXKtdr5t9+W/0tS602WVM4Q
# Um1OTqCvfUsmkKGjUKIQ9luu4hukWPt5CfIAw03JUUcKAzRQ4+lyk2SRlUSDJiDk
# 7O70u/glv8bZ8pdl7hWvVPDv71VWl/jLg3rgpf/6LYJl4Dq7zvawzhRcoML5qB9T
# ao0Baew=
