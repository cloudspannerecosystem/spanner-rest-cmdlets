...
Import-Module -Force "$scriptFolder\gSecret.psm1"
Describe 'Secrets' {
    it 'read and write with Facility' {
        $Facility = 'gSecret.Tests'
        $value = 314159265
        Set-gSecret -Facility $Facility -Name Test -Value $value
        $v = Get-gSecret -Facility $Facility -Name Test
        $v | Should be $Value
        Remove-gSecret -Facility $Facility -Name Test
    }
    it 'read and write with Domain' {
        $Domain = [System.Guid]'c8758b0d-c8f2-461d-a12c-6781d06b94b8'
        $value = 314159265
        Set-gSecret -Domain $Domain -Name Test -Value $value
        $v = Get-gSecret -Domain $Domain -Name Test
        $v | Should be $Value
        Remove-gSecret -Domain $Domain -Name Test
    }
}
# SIG # Begin signature block
# MIIdEQYJKoZIhvcNAQcCoIIdAjCCHP4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnZKfq2znsFCOG9OCmpsNH95O
# Q2OgghiiMIIFNTCCAx2gAwIBAgIQT/hgdSzRMK1Ptmol1X/K6zANBgkqhkiG9w0B
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFK22mHRS
# viAwkoIvtePPnxlwmzYGMA0GCSqGSIb3DQEBAQUABIIBAABmNcjr1dbSLQHNCPfc
# EuyjVl6F8hIRQgTNtrJMX6xciCBRTWpjBcQfI5/phc6N+ORhXUNNLA8v3LanLMXF
# nKpQFh+cQwkCvsPgvFed+S15+lLtFcnFrKwC7DsA1dA+BNW3FYRKhFEVU3pzYNs/
# x0MEQktxXRL1aVzC1PYc4WkxbHG8I86vY3qjuOnkLBhxLw634BjEg+w6DnqT99nc
# mT1MwdPPKkUOxDwzRd94IvFaWiYaJdoiU2Mjmd4wKd5kKk2P6fp1jf/qFdbxF0QT
# MnFhsgoZUZgou7tpunuNPHh6qXzAffKLNYBB57aIClXInbiB4LsjNuyxvclgajnV
# 8ZChggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgCAQEwdjBiMQswCQYDVQQGEwJV
...
# HAYJKoZIhvcNAQkFMQ8XDTIwMDUyNzE5NTk0MlowIwYJKoZIhvcNAQkEMRYEFCJ9
# Jxuc4mMQxDAw9+pukgWfRE3HMA0GCSqGSIb3DQEBAQUABIIBAD+fPUeTeoqUCCUk
# /8ExWGA6ga6XBwbwIGASGEuax6jgYa/lZROtHDdPmgxG0Kt+XPWC9Ug5XIwFAOsT
# khqxmQex5eiB42KxNGnv4BJTnm/+7fnPF2lwBIAYvCHv+WFhq7Jsz7m6a2x6PiAP
# J6+84DV6HwA7GIY3w47ON3Qr1KIVOz2Xt9i9v4StcZm7XPkjSQFH2qeQODErFzM2
# ZmVY+wzNR0AQdB4sja1AyHEsQYMcpiNXoernOeOUcEfS5P/ONK/bkUrpXcTVREhp
# WxchrVGXHW11U65GcAvrMXtgcX+XeYBccVhsjEZEBbr2BkQM9A0o5S18c9Qn73j+
# sgt5zu0=
